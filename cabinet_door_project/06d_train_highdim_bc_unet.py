"""
Step 6d: Train a Scaled-up High-Dim BC Policy with 1D U-Net
=================================================
...
Usage:
    python 06d_train_highdim_bc_unet.py
    python 06d_train_highdim_bc_unet.py --epochs 100 --batch_size 128
    python 06d_train_highdim_bc_unet.py --checkpoint_dir /tmp/highdim_bc_unet_checkpoints
"""
...
def main():
    ...
    parser.add_argument("--checkpoint_dir", type=str, default="highdim_bc_unet_checkpoints/")
    ...
    print("=" * 60)
    print("  OpenCabinet - Scaled-up High-Dim BC 1D U-Net Policy Training (~13M-14M params)")
    print("=" * 60)
